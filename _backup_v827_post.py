"""v8.27 轮前备份：把本轮将修改的文件拷贝到 backups/20260905_v827_post/（保留相对结构）。
...
BAK = ROOT / "backups" / "20260905_v827_post"
FILES = [
...
def main() -> int:
    ...
    for rel in FILES:
        ...
        n += 1
    print(f"[OK] backed up {n} files to backups/20260905_v827_post/")
    return 0
